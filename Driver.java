...
public class Driver 
{
	...
	{
		Driver.displayBoard();
		System.out.println ("X player enter a row:"); 
		int rowX = Driver.getIntFromUser();
		System.out.println ("X player enter a column:");
		int columnX = Driver.getIntFromUser();
		Driver.makeMovePlrX(rowX, columnX, 'X');
		Driver.displayBoard();
		
		Driver.displayBoard();
		System.out.println ("O player enter a row:"); 
		int rowO = Driver.getIntFromUser();
		System.out.println (" player enter a column:");
		int columnO = Driver.getIntFromUser();
		Driver.makeMovePlrO(rowO, columnO, 'X');
		Driver.displayBoard();
	...
	static void makeMovePlrX (int rowX, int column, char move)
	{
		char[] theRow = row1;
		if(rowX == 2)
		{
	...
	static void makeMovePlrO (int row, int column, char move)
	{
		char [] theRow = row1:
		if(rowO == 2)
		}
